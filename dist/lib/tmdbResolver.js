...
exports.resolveTmdbToImdb = void 0;
 ...
 */
function resolveTmdbToImdb(id, type = 'movie') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (data.imdb_id) {
                ...
                cache_1.default.set(cacheKey, data.imdb_id, 24 * 60 * 60 * 1000);
                return data.imdb_id;
            }
            ...
            try {
                ...
                if (match && match[1]) {
                    ...
                    // Cache the result for 24 hours
                    cache_1.default.set(cacheKey, imdbId, 24 * 60 * 60 * 1000);
                    return imdbId;
                }
...
exports.resolveTmdbToImdb = resolveTmdbToImdb;
